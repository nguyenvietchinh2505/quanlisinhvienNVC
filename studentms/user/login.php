...
setcookie ("Tên đăng nhập",$_POST["stuid"],time()+ (10 * 365 * 24 * 60 * 60));
//COOKIES for password
setcookie ("Mật khẩu",$_POST["password"],time()+ (10 * 365 * 24 * 60 * 60));
} else {
if(isset($_COOKIE["Tên đăng nhập"])) {
setcookie ("Tên đăng nhập","");
if(isset($_COOKIE["Mật khẩu"])) {
setcookie ("Mật khẩu","");
        }
      }
}
